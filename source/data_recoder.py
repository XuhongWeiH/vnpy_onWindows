...
setting_data["database.database"] = "funture_data"
...
class WholeMarketRecorder(RecorderEngine):
    def __init__(self, main_engine, event_engine, record_modes=[RecordMode.TICK, RecordMode.BAR]):
...
def run_parent():
    ...
    while True:
        ...
        trading = False
        if trading == False:
            print('\r' + str(current_time).split('.')[0], end='', flush=True)
