...
from vnpy.trader.vtTrader.language import constant
from vnpy.trader.vtTrader.vtConstant import (EMPTY_FLOAT, EMPTY_INT, EMPTY_STRING, EMPTY_UNICODE)
...
class VtBarData(VtBaseData):
    ...
    def __init__(self):
        ...
        self.low_limit = EMPTY_FLOAT
        self.high_limit = EMPTY_FLOAT
        
        self.factor = EMPTY_FLOAT
        self.avg = EMPTY_FLOAT
        self.pre_close = EMPTY_FLOAT
        self.paused = EMPTY_FLOAT
        
        self.datetime = None                # python的datetime时间对象
        
        self.volume = EMPTY_INT             # 成交量
        self.money = EMPTY_FLOAT            #交易额
        self.open_interest = None       # 持仓量  
